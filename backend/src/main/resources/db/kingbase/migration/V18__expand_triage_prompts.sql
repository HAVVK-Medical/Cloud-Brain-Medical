...
- 鍜冲椊銆佸挸鐥般€佽兏闂枫€佹皵鐭綋鍔涘樊 鈫?鍛煎惛鍐呯(respiratory-medicine)
- 鑵归儴鐥涖€佽吂娉汇€佸弽閰搞€佹秷鍖栦笉鑹悜 鈫?娑堝寲鍐呯(gastroenterology)
- 鐢茬姸鑵哄紓甯搞€佺硸灏跨梾銆侀珮琛€鑴?鈫?鍐呭垎娉岀(endocrinology)
- 鑰抽福銆佸惉鍔涗笅闄嶃€侀蓟濉炪€佸枆鍜欑棝 鈫?鑰抽蓟鍠夌(otolaryngology)
- 瑙嗗姏涓嬮檷銆佺溂绾紝鐪肩棝銆佸共鐪?鈫?鐪肩(ophthalmology)
- 灏块銆佽灏裤€佸皬鑵硅儉銆佸墠鍒楄吅闂 鈫?娉屽翱澶栫(urology)
...
- respiratory-medicine: 鍛煎惛鍐呯锛堝挸鍡姐€佸挸鐥般€佽兏闂枫€佹皵鐭綋鍔涘樊锛?
- gastroenterology: 娑堝寲鍐呯锛堣吂鐥涖€佽吂娉汇€佸弽閰搞€佹秷鍖栦笉鑹級
- endocrinology: 鍐呭垎娉岀锛堢硸灏跨梾銆佺敳鐘惰吅寮傚父銆侀珮琛€鑴傦級
- otolaryngology: 鑰抽蓟鍠夌锛堣€抽福銆佸惉鍔涗笅闄嶃€侀蓟濉炪€佸枆鍜欑棝锛?
- ophthalmology: 鐪肩锛堣鍔涗笅闄嶃€佺溂绾€佺溂鐥涖€佸共鐪硷級
- urology: 娉屽翱澶栫锛堝翱棰戙€佽灏裤€佸皬鑵硅儉銆佸墠鍒楄吅闂锛?
- gynecology: 濡囩锛堟湀缁忓紓甯搞€佸嚭琛€銆佸绉戠値鐥囷級
