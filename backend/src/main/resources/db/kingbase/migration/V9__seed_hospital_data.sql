...
SELECT d.id, (SELECT id FROM department WHERE code = 'internal-medicine'), (CURRENT_DATE + days.n), 'AM', 30, 15 + CAST(FLOOR(RANDOM() * 16) AS INTEGER), 'NORMAL', 'ACTIVE', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
INSERT INTO schedule (doctor_id, department_id, work_date, period, total_slots, remaining_slots, visit_level, status, version, created_at, updated_at)
SELECT d.id, (SELECT id FROM department WHERE code = 'internal-medicine'), (CURRENT_DATE + days.n), 'PM', 20, 5 + CAST(FLOOR(RANDOM() * 16) AS INTEGER), 'NORMAL', 'ACTIVE', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM (SELECT id FROM doctor WHERE username = 'doctor01') d
CROSS JOIN (SELECT 0 AS n UNION SELECT 1 UNION SELECT 2 UNION SELECT 3 UNION SELECT 4 UNION SELECT 5 UNION SELECT 6) days
...
-- doctor02 (李心怡, 心内科)
INSERT INTO schedule (doctor_id, department_id, work_date, period, total_slots, remaining_slots, visit_level, status, version, created_at, updated_at)
SELECT d.id, (SELECT id FROM department WHERE code = 'cardiology'), (CURRENT_DATE + days.n), period.p, period.slots, GREATEST(0, period.slots - CAST(FLOOR(RANDOM() * 20) AS INTEGER)), 'NORMAL', 'ACTIVE', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
-- doctor03 (王建华, 神经内科)
INSERT INTO schedule (doctor_id, department_id, work_date, period, total_slots, remaining_slots, visit_level, status, version, created_at, updated_at)
SELECT d.id, (SELECT id FROM department WHERE code = 'neurology'), (CURRENT_DATE + days.n), period.p, period.slots, GREATEST(0, period.slots - CAST(FLOOR(RANDOM() * 20) AS INTEGER)), 'NORMAL', 'ACTIVE', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
-- doctor05 (赵刚, 骨科)
INSERT INTO schedule (doctor_id, department_id, work_date, period, total_slots, remaining_slots, visit_level, status, version, created_at, updated_at)
SELECT d.id, (SELECT id FROM department WHERE code = 'orthopedics'), (CURRENT_DATE + days.n), period.p, period.slots, GREATEST(0, period.slots - CAST(FLOOR(RANDOM() * 20) AS INTEGER)), 'NORMAL', 'ACTIVE', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
-- doctor07 (孙丽华, 皮肤科)
INSERT INTO schedule (doctor_id, department_id, work_date, period, total_slots, remaining_slots, visit_level, status, version, created_at, updated_at)
SELECT d.id, (SELECT id FROM department WHERE code = 'dermatology'), (CURRENT_DATE + days.n), period.p, period.slots, GREATEST(0, period.slots - CAST(FLOOR(RANDOM() * 20) AS INTEGER)), 'NORMAL', 'ACTIVE', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
